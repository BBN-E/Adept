...
/**
 * Unit test class to test relation insertion
 * functionality
 */
public class TestInsertRelation {
	...
	public void testInsertRelation() 
	{
		try
		{
			...
			relationMentionBuilder.setConfidence(0.9f);
            ...
            documentRelationBuilder.setConfidence(0.9f);
			...
			KBID relationId = updateProcessor.insertRelation(documentRelationBuilder.build(), entityMap, externalKbIds);
		    System.out.println("Inserted relation: " + relationId.getKBUri());
            assertTrue(relationId != null);
		    
		    TestKBUri.setKBRelationUri(relationId);
