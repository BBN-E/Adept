...
+---------------------*/
		...
		throws UnsupportedEncodingException, IOException
	{
		...
		Map<String, Object> inputStreamParameters = new HashMap<String, Object>();
		Map<String, Object> nonInputStreamParameters = new HashMap<String, Object>();
    ...
    * </pre>
	...
	public static byte[] buildMultipartFormData(Map<String, Object> parameters, String boundary, String encoding, boolean includeEndBoundary)
		throws UnsupportedEncodingException
	{
		List<byte[]> parts = new ArrayList<byte[]>(parameters.size());
		int partLengthSum = 0;
