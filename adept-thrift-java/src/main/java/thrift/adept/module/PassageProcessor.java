...
public class PassageProcessor {
  ...
  public interface Iface {
    ...
    public List<thrift.adept.common.HltContentUnion> process(thrift.adept.common.Passage passage) throws org.apache.thrift.TException;

    public long processAsync(thrift.adept.common.Passage passage) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void process(thrift.adept.common.Passage passage, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.process_call> resultHandler) throws org.apache.thrift.TException;

    public void processAsync(thrift.adept.common.Passage passage, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.processAsync_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_process(thrift.adept.common.Passage passage) throws org.apache.thrift.TException
    {
      process_args args = new process_args();
      args.setPassage(passage);
    ...
    public void send_processAsync(thrift.adept.common.Passage passage) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void process(thrift.adept.common.Passage passage, org.apache.thrift.async.AsyncMethodCallback<process_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      process_call method_call = new process_call(passage, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class process_call extends org.apache.thrift.async.TAsyncMethodCall {
      private thrift.adept.common.Passage passage;
      public process_call(thrift.adept.common.Passage passage, org.apache.thrift.async.AsyncMethodCallback<process_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public void processAsync(thrift.adept.common.Passage passage, org.apache.thrift.async.AsyncMethodCallback<processAsync_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      processAsync_call method_call = new processAsync_call(passage, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class processAsync_call extends org.apache.thrift.async.TAsyncMethodCall {
      private thrift.adept.common.Passage passage;
      public processAsync_call(thrift.adept.common.Passage passage, org.apache.thrift.async.AsyncMethodCallback<processAsync_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.passage = passage;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class process<I extends Iface> extends org.apache.thrift.ProcessFunction<I, process_args> {
      ...
      public process_result getResult(I iface, process_args args) throws org.apache.thrift.TException {
        process_result result = new process_result();
        result.success = iface.process(args.passage);
        return result;
      }
    }
    ...
    public static class processAsync<I extends Iface> extends org.apache.thrift.ProcessFunction<I, processAsync_args> {
      ...
      public processAsync_result getResult(I iface, processAsync_args args) throws org.apache.thrift.TException {
        processAsync_result result = new processAsync_result();
        result.success = iface.processAsync(args.passage);
  ...
  public static class process_args implements org.apache.thrift.TBase<process_args, process_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final org.apache.thrift.protocol.TField PASSAGE_FIELD_DESC = new org.apache.thrift.protocol.TField("passage", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public thrift.adept.common.Passage passage; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      PASSAGE((short)1, "passage");
    ...
    public process_args(process_args other) {
      if (other.isSetPassage()) {
        this.passage = new thrift.adept.common.Passage(other.passage);
      }
    }
    ...
    public process_args setPassage(thrift.adept.common.Passage passage) {
      this.passage = passage;
      return this;
    }

    public void unsetPassage() {
      this.passage = null;
    }

    /** Returns true if field passage is set (has been assigned a value) and false otherwise */
    public boolean isSetPassage() {
      return this.passage != null;
    }

    public void setPassageIsSet(boolean value) {
      if (!value) {
        this.passage = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case PASSAGE:
        if (value == null) {
          ...
          setPassage((thrift.adept.common.Passage)value);
        }
        break;
    ...
    public boolean equals(process_args that) {
      ...
      boolean this_present_passage = true && this.isSetPassage();
      boolean that_present_passage = true && that.isSetPassage();
      if (this_present_passage || that_present_passage) {
        if (!(this_present_passage && that_present_passage))
          return false;
        if (!this.passage.equals(that.passage))
          return false;
      }
    ...
    public int compareTo(process_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetPassage()).compareTo(typedOther.isSetPassage());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetPassage()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.passage, typedOther.passage);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    private static class process_argsStandardScheme extends StandardScheme<process_args> {
          ...
          switch (schemeField.id) {
            case 1: // PASSAGE
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.passage = new thrift.adept.common.Passage();
                struct.passage.read(iprot);
                struct.setPassageIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, process_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.passage != null) {
          oprot.writeFieldBegin(PASSAGE_FIELD_DESC);
          struct.passage.write(oprot);
          oprot.writeFieldEnd();
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<thrift.adept.common.HltContentUnion>(_list58.size);
                  for (int _i59 = 0; _i59 < _list58.size; ++_i59)
                  {
                    thrift.adept.common.HltContentUnion _elem60; // required
                    _elem60 = new thrift.adept.common.HltContentUnion();
                    _elem60.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, process_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (thrift.adept.common.HltContentUnion _iter61 : struct.success)
            {
              _iter61.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (thrift.adept.common.HltContentUnion _iter62 : struct.success)
            {
              _iter62.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<thrift.adept.common.HltContentUnion>(_list63.size);
            for (int _i64 = 0; _i64 < _list63.size; ++_i64)
            {
              thrift.adept.common.HltContentUnion _elem65; // required
              _elem65 = new thrift.adept.common.HltContentUnion();
              _elem65.read(iprot);
  ...
  public static class processAsync_args implements org.apache.thrift.TBase<processAsync_args, processAsync_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public processAsync_args setPassage(thrift.adept.common.Passage passage) {
      this.passage = passage;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.metaContents = new ArrayList<thrift.adept.common.HltContentUnion>(_list66.size);
                  for (int _i67 = 0; _i67 < _list66.size; ++_i67)
                  {
                    thrift.adept.common.HltContentUnion _elem68; // required
                    _elem68 = new thrift.adept.common.HltContentUnion();
                    _elem68.read(iprot);
                    struct.metaContents.add(_elem68);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, tryGetResult_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.metaContents != null) {
          oprot.writeFieldBegin(META_CONTENTS_FIELD_DESC);
          {
            ...
            for (thrift.adept.common.HltContentUnion _iter69 : struct.metaContents)
            {
              _iter69.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetMetaContents()) {
          {
            ...
            for (thrift.adept.common.HltContentUnion _iter70 : struct.metaContents)
            {
              _iter70.write(oprot);
            }
          }
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.metaContents = new ArrayList<thrift.adept.common.HltContentUnion>(_list71.size);
            for (int _i72 = 0; _i72 < _list71.size; ++_i72)
            {
              thrift.adept.common.HltContentUnion _elem73; // required
              _elem73 = new thrift.adept.common.HltContentUnion();
              _elem73.read(iprot);
              struct.metaContents.add(_elem73);
            }
          }
          struct.setMetaContentsIsSet(true);
        }
