...
public class DocumentListProcessor {
  ...
  public interface Iface {
    ...
    public thrift.adept.common.HltContentContainer process(thrift.adept.common.DocumentList documentList, thrift.adept.common.HltContentContainer hltContentContainer) throws org.apache.thrift.TException;

    public long processAsync(thrift.adept.common.DocumentList documentList, thrift.adept.common.HltContentContainer hltContentContainer) throws org.apache.thrift.TException;

    public boolean tryGetResult(long requestId, thrift.adept.common.HltContentContainer hltContentContainer) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void process(thrift.adept.common.DocumentList documentList, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.process_call> resultHandler) throws org.apache.thrift.TException;

    public void processAsync(thrift.adept.common.DocumentList documentList, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.processAsync_call> resultHandler) throws org.apache.thrift.TException;

    public void tryGetResult(long requestId, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.tryGetResult_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_process(thrift.adept.common.DocumentList documentList, thrift.adept.common.HltContentContainer hltContentContainer) throws org.apache.thrift.TException
    {
      process_args args = new process_args();
      args.setDocumentList(documentList);
      args.setHltContentContainer(hltContentContainer);
      sendBase("process", args);
    }

    public thrift.adept.common.HltContentContainer recv_process() throws org.apache.thrift.TException
    {
    ...
    public void send_processAsync(thrift.adept.common.DocumentList documentList, thrift.adept.common.HltContentContainer hltContentContainer) throws org.apache.thrift.TException
    {
    ...
    public void send_tryGetResult(long requestId, thrift.adept.common.HltContentContainer hltContentContainer) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void process(thrift.adept.common.DocumentList documentList, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<process_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      process_call method_call = new process_call(documentList, hltContentContainer, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class process_call extends org.apache.thrift.async.TAsyncMethodCall {
      private thrift.adept.common.DocumentList documentList;
      private thrift.adept.common.HltContentContainer hltContentContainer;
      public process_call(thrift.adept.common.DocumentList documentList, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<process_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public void processAsync(thrift.adept.common.DocumentList documentList, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<processAsync_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      processAsync_call method_call = new processAsync_call(documentList, hltContentContainer, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class processAsync_call extends org.apache.thrift.async.TAsyncMethodCall {
      private thrift.adept.common.DocumentList documentList;
      private thrift.adept.common.HltContentContainer hltContentContainer;
      public processAsync_call(thrift.adept.common.DocumentList documentList, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<processAsync_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.documentList = documentList;
        this.hltContentContainer = hltContentContainer;
      }
    ...
    public void tryGetResult(long requestId, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<tryGetResult_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      tryGetResult_call method_call = new tryGetResult_call(requestId, hltContentContainer, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class tryGetResult_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private thrift.adept.common.HltContentContainer hltContentContainer;
      public tryGetResult_call(long requestId, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<tryGetResult_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class process<I extends Iface> extends org.apache.thrift.ProcessFunction<I, process_args> {
      ...
      public process_result getResult(I iface, process_args args) throws org.apache.thrift.TException {
        process_result result = new process_result();
        result.success = iface.process(args.documentList, args.hltContentContainer);
        return result;
      }
    }
    ...
    public static class processAsync<I extends Iface> extends org.apache.thrift.ProcessFunction<I, processAsync_args> {
      ...
      public processAsync_result getResult(I iface, processAsync_args args) throws org.apache.thrift.TException {
        processAsync_result result = new processAsync_result();
        result.success = iface.processAsync(args.documentList, args.hltContentContainer);
    ...
    public static class tryGetResult<I extends Iface> extends org.apache.thrift.ProcessFunction<I, tryGetResult_args> {
      ...
      public tryGetResult_result getResult(I iface, tryGetResult_args args) throws org.apache.thrift.TException {
        tryGetResult_result result = new tryGetResult_result();
        result.success = iface.tryGetResult(args.requestId, args.hltContentContainer);
        result.setSuccessIsSet(true);
        return result;
      }
    }
  ...
  public static class process_args implements org.apache.thrift.TBase<process_args, process_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final org.apache.thrift.protocol.TField DOCUMENT_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("documentList", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    static {
      ...
      tmpMap.put(_Fields.DOCUMENT_LIST, new org.apache.thrift.meta_data.FieldMetaData("documentList", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, thrift.adept.common.DocumentList.class)));
    ...
    public process_args(process_args other) {
      if (other.isSetDocumentList()) {
        this.documentList = new thrift.adept.common.DocumentList(other.documentList);
      }
    ...
    public thrift.adept.common.DocumentList getDocumentList() {
      return this.documentList;
    }

    public process_args setDocumentList(thrift.adept.common.DocumentList documentList) {
      this.documentList = documentList;
      return this;
    }
    ...
    /** Returns true if field documentList is set (has been assigned a value) and false otherwise */
    public boolean isSetDocumentList() {
      return this.documentList != null;
    }

    public void setDocumentListIsSet(boolean value) {
      if (!value) {
        this.documentList = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case DOCUMENT_LIST:
        if (value == null) {
          ...
          setDocumentList((thrift.adept.common.DocumentList)value);
        }
        break;
    ...
    public boolean equals(process_args that) {
      ...
      boolean this_present_documentList = true && this.isSetDocumentList();
      boolean that_present_documentList = true && that.isSetDocumentList();
      if (this_present_documentList || that_present_documentList) {
        if (!(this_present_documentList && that_present_documentList))
          return false;
        if (!this.documentList.equals(that.documentList))
          return false;
      }
    ...
    public int compareTo(process_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetDocumentList()).compareTo(typedOther.isSetDocumentList());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDocumentList()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.documentList, typedOther.documentList);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    private static class process_argsStandardScheme extends StandardScheme<process_args> {
          ...
          switch (schemeField.id) {
            case 1: // DOCUMENT_LIST
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.documentList = new thrift.adept.common.DocumentList();
                struct.documentList.read(iprot);
                struct.setDocumentListIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, process_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.documentList != null) {
          oprot.writeFieldBegin(DOCUMENT_LIST_FIELD_DESC);
          struct.documentList.write(oprot);
          oprot.writeFieldEnd();
        }
  ...
  public static class process_result implements org.apache.thrift.TBase<process_result, process_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public process_result setSuccess(thrift.adept.common.HltContentContainer success) {
      this.success = success;
      return this;
    }
  ...
  public static class processAsync_args implements org.apache.thrift.TBase<processAsync_args, processAsync_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public processAsync_args setDocumentList(thrift.adept.common.DocumentList documentList) {
      this.documentList = documentList;
      return this;
    }
  ...
  public static class tryGetResult_args implements org.apache.thrift.TBase<tryGetResult_args, tryGetResult_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public tryGetResult_args setHltContentContainer(thrift.adept.common.HltContentContainer hltContentContainer) {
      this.hltContentContainer = hltContentContainer;
      return this;
    }
