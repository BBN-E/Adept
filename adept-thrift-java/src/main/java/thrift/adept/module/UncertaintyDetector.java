...
/**
 * The Class UncertaintyDetector - An instance of UncertaintyDetector can be
 * created to support Sentence, DiscoureUnit and ProsodicPhrase output.
 * 
 * @param <T>
 *            the generic type
 */
public class UncertaintyDetector extends AbstractModule
		implements DocumentHltContentProcessor.Iface {
