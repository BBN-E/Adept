...
public class DocumentHltContentProcessor {

  public interface Iface {

    public List<thrift.adept.common.HltContentUnion> process(thrift.adept.common.Document document, thrift.adept.common.HltContentContainer hltContentContainer) throws org.apache.thrift.TException;

    public long processAsync(thrift.adept.common.Document document, thrift.adept.common.HltContentContainer hltContentContainer) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void process(thrift.adept.common.Document document, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.process_call> resultHandler) throws org.apache.thrift.TException;

    public void processAsync(thrift.adept.common.Document document, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.processAsync_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_process(thrift.adept.common.Document document, thrift.adept.common.HltContentContainer hltContentContainer) throws org.apache.thrift.TException
    {
    ...
    public void send_processAsync(thrift.adept.common.Document document, thrift.adept.common.HltContentContainer hltContentContainer) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void process(thrift.adept.common.Document document, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<process_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      process_call method_call = new process_call(document, hltContentContainer, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class process_call extends org.apache.thrift.async.TAsyncMethodCall {
      private thrift.adept.common.Document document;
      private thrift.adept.common.HltContentContainer hltContentContainer;
      public process_call(thrift.adept.common.Document document, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<process_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public void processAsync(thrift.adept.common.Document document, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<processAsync_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      processAsync_call method_call = new processAsync_call(document, hltContentContainer, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class processAsync_call extends org.apache.thrift.async.TAsyncMethodCall {
      private thrift.adept.common.Document document;
      private thrift.adept.common.HltContentContainer hltContentContainer;
      public processAsync_call(thrift.adept.common.Document document, thrift.adept.common.HltContentContainer hltContentContainer, org.apache.thrift.async.AsyncMethodCallback<processAsync_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.document = document;
        this.hltContentContainer = hltContentContainer;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class process<I extends Iface> extends org.apache.thrift.ProcessFunction<I, process_args> {
      ...
      public process_result getResult(I iface, process_args args) throws org.apache.thrift.TException {
        process_result result = new process_result();
        result.success = iface.process(args.document, args.hltContentContainer);
        return result;
      }
    }
    ...
    public static class processAsync<I extends Iface> extends org.apache.thrift.ProcessFunction<I, processAsync_args> {
      ...
      public processAsync_result getResult(I iface, processAsync_args args) throws org.apache.thrift.TException {
        processAsync_result result = new processAsync_result();
        result.success = iface.processAsync(args.document, args.hltContentContainer);
  ...
  public static class process_args implements org.apache.thrift.TBase<process_args, process_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final org.apache.thrift.protocol.TField HLT_CONTENT_CONTAINER_FIELD_DESC = new org.apache.thrift.protocol.TField("hltContentContainer", org.apache.thrift.protocol.TType.STRUCT, (short)2);
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      ...
      HLT_CONTENT_CONTAINER((short)2, "hltContentContainer");
    ...
    public process_args setDocument(thrift.adept.common.Document document) {
      this.document = document;
      return this;
    }
    ...
    public process_args setHltContentContainer(thrift.adept.common.HltContentContainer hltContentContainer) {
      this.hltContentContainer = hltContentContainer;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<thrift.adept.common.HltContentUnion>(_list26.size);
                  for (int _i27 = 0; _i27 < _list26.size; ++_i27)
                  {
                    thrift.adept.common.HltContentUnion _elem28; // required
                    _elem28 = new thrift.adept.common.HltContentUnion();
                    _elem28.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, process_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (thrift.adept.common.HltContentUnion _iter29 : struct.success)
            {
              _iter29.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (thrift.adept.common.HltContentUnion _iter30 : struct.success)
            {
              _iter30.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<thrift.adept.common.HltContentUnion>(_list31.size);
            for (int _i32 = 0; _i32 < _list31.size; ++_i32)
            {
              thrift.adept.common.HltContentUnion _elem33; // required
              _elem33 = new thrift.adept.common.HltContentUnion();
              _elem33.read(iprot);
  ...
  public static class processAsync_args implements org.apache.thrift.TBase<processAsync_args, processAsync_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public processAsync_args setDocument(thrift.adept.common.Document document) {
      this.document = document;
      return this;
    }
    ...
    public processAsync_args setHltContentContainer(thrift.adept.common.HltContentContainer hltContentContainer) {
      this.hltContentContainer = hltContentContainer;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.hltContents = new ArrayList<thrift.adept.common.HltContentUnion>(_list34.size);
                  for (int _i35 = 0; _i35 < _list34.size; ++_i35)
                  {
                    thrift.adept.common.HltContentUnion _elem36; // required
                    _elem36 = new thrift.adept.common.HltContentUnion();
                    _elem36.read(iprot);
                    struct.hltContents.add(_elem36);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, tryGetResult_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.hltContents != null) {
          oprot.writeFieldBegin(HLT_CONTENTS_FIELD_DESC);
          {
            ...
            for (thrift.adept.common.HltContentUnion _iter37 : struct.hltContents)
            {
              _iter37.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetHltContents()) {
          {
            ...
            for (thrift.adept.common.HltContentUnion _iter38 : struct.hltContents)
            {
              _iter38.write(oprot);
            }
          }
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.hltContents = new ArrayList<thrift.adept.common.HltContentUnion>(_list39.size);
            for (int _i40 = 0; _i40 < _list39.size; ++_i40)
            {
              thrift.adept.common.HltContentUnion _elem41; // required
              _elem41 = new thrift.adept.common.HltContentUnion();
              _elem41.read(iprot);
              struct.hltContents.add(_elem41);
            }
          }
          struct.setHltContentsIsSet(true);
        }
