 ...
 */
public class DiscourseUnit implements org.apache.thrift.TBase<DiscourseUnit, DiscourseUnit._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DiscourseUnit");
  ...
  private static final org.apache.thrift.protocol.TField DISCOURCE_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("discourceType", org.apache.thrift.protocol.TType.STRING, (short)5);
  ...
  private static final org.apache.thrift.protocol.TField UNCERTAINTY_CONFIDENCE_FIELD_DESC = new org.apache.thrift.protocol.TField("uncertaintyConfidence", org.apache.thrift.protocol.TType.DOUBLE, (short)7);
  ...
  private static final org.apache.thrift.protocol.TField VALUE_FIELD_DESC = new org.apache.thrift.protocol.TField("value", org.apache.thrift.protocol.TType.STRING, (short)9);
  private static final org.apache.thrift.protocol.TField ALGORITHM_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("algorithmName", org.apache.thrift.protocol.TType.STRING, (short)10);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new DiscourseUnitStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DiscourseUnitTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * The discourse type
     */
    DISCOURCE_TYPE((short)5, "discourceType"),
    /**
     * The novelty confidence
     */
     ...
     * The uncertainty confidence
     */
    UNCERTAINTY_CONFIDENCE((short)7, "uncertaintyConfidence"),
    /**
     * The id
     */
    ID((short)8, "id"),
     ...
     * The algorithmName
     */
    ALGORITHM_NAME((short)10, "algorithmName");
  ...
  private _Fields optionals[] = {_Fields.CHAR_OFFSET,_Fields.NOVELTY_CONFIDENCE,_Fields.UNCERTAINTY_CONFIDENCE,_Fields.ID,_Fields.VALUE,_Fields.ALGORITHM_NAME};
  ...
  static {
    ...
    tmpMap.put(_Fields.DISCOURCE_TYPE, new org.apache.thrift.meta_data.FieldMetaData("discourceType", org.apache.thrift.TFieldRequirementType.REQUIRED, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DiscourseUnit.class, metaDataMap);
  }

  public DiscourseUnit() {
  }
   ...
   */
  public DiscourseUnit(DiscourseUnit other) {
   ...
   * The token offset which is the index into token stream.
   */
  public DiscourseUnit setTokenOffset(TokenOffset tokenOffset) {
    this.tokenOffset = tokenOffset;
    return this;
  }
   ...
   * The token stream
   */
  public DiscourseUnit setTokenStream(TokenStream tokenStream) {
    this.tokenStream = tokenStream;
    return this;
  }
   ...
   * The char offset
   */
  public DiscourseUnit setCharOffset(CharOffset charOffset) {
   ...
   * The sequence id
   */
  public DiscourseUnit setSequenceId(long sequenceId) {
    this.sequenceId = sequenceId;
    setSequenceIdIsSet(true);
    return this;
  }
   ...
   * The discourse type
   */
  public DiscourseUnit setDiscourceType(String discourceType) {
    this.discourceType = discourceType;
    return this;
  }
   ...
   * The novelty confidence
   */
  public DiscourseUnit setNoveltyConfidence(double noveltyConfidence) {
   ...
   * The uncertainty confidence
   */
  public DiscourseUnit setUncertaintyConfidence(double uncertaintyConfidence) {
   ...
   * The id
   */
  public DiscourseUnit setId(ID id) {
    this.id = id;
    return this;
  }
   ...
   * The value
   */
  public DiscourseUnit setValue(String value) {
    this.value = value;
    return this;
  }
   ...
   * The algorithmName
   */
  public DiscourseUnit setAlgorithmName(String algorithmName) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DiscourseUnit)
      return this.equals((DiscourseUnit)that);
    return false;
  }

  public boolean equals(DiscourseUnit that) {
    if (that == null)
      return false;
  ...
  public int compareTo(DiscourseUnit other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    DiscourseUnit typedOther = (DiscourseUnit)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DiscourseUnit(");
    boolean first = true;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (discourceType == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'discourceType' was not present! Struct: " + toString());
    }
  ...
  private static class DiscourseUnitStandardSchemeFactory implements SchemeFactory {
    public DiscourseUnitStandardScheme getScheme() {
      return new DiscourseUnitStandardScheme();
    }
  }

  private static class DiscourseUnitStandardScheme extends StandardScheme<DiscourseUnit> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DiscourseUnit struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DiscourseUnit struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DiscourseUnitTupleSchemeFactory implements SchemeFactory {
    public DiscourseUnitTupleScheme getScheme() {
      return new DiscourseUnitTupleScheme();
    }
  }

  private static class DiscourseUnitTupleScheme extends TupleScheme<DiscourseUnit> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DiscourseUnit struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DiscourseUnit struct) throws org.apache.thrift.TException {
