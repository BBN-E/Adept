 ...
 */
public class PartOfSpeech implements org.apache.thrift.TBase<PartOfSpeech, PartOfSpeech._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PartOfSpeech");
  ...
  private static final org.apache.thrift.protocol.TField POS_TAG_FIELD_DESC = new org.apache.thrift.protocol.TField("posTag", org.apache.thrift.protocol.TType.STRUCT, (short)5);
  ...
  static {
    schemes.put(StandardScheme.class, new PartOfSpeechStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PartOfSpeechTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.CHAR_OFFSET,_Fields.POS_TAG,_Fields.ID,_Fields.VALUE,_Fields.ALGORITHM_NAME};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PartOfSpeech.class, metaDataMap);
  }
   ...
   * The sequence id
   */
  public PartOfSpeech setSequenceId(long sequenceId) {
    this.sequenceId = sequenceId;
    setSequenceIdIsSet(true);
    return this;
  }
   ...
   * The token offset which is the index into token stream.
   */
  public PartOfSpeech setTokenOffset(TokenOffset tokenOffset) {
    this.tokenOffset = tokenOffset;
    return this;
  }
   ...
   * The token stream
   */
  public PartOfSpeech setTokenStream(TokenStream tokenStream) {
    this.tokenStream = tokenStream;
    return this;
  }
   ...
   * The char offset
   */
  public PartOfSpeech setCharOffset(CharOffset charOffset) {
   ...
   * The part of speech tag
   */
  public PartOfSpeech setPosTag(Type posTag) {
    this.posTag = posTag;
    return this;
  }
   ...
   * The id
   */
  public PartOfSpeech setId(ID id) {
    this.id = id;
    return this;
  }
   ...
   * The value
   */
  public PartOfSpeech setValue(String value) {
    this.value = value;
    return this;
  }
   ...
   * The algorithmName
   */
  public PartOfSpeech setAlgorithmName(String algorithmName) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PartOfSpeech)
      return this.equals((PartOfSpeech)that);
    return false;
  }

  public boolean equals(PartOfSpeech that) {
    if (that == null)
      return false;
  ...
  public int compareTo(PartOfSpeech other) {
    ...
    PartOfSpeech typedOther = (PartOfSpeech)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PartOfSpeech(");
    boolean first = true;
  ...
  private static class PartOfSpeechStandardSchemeFactory implements SchemeFactory {
    public PartOfSpeechStandardScheme getScheme() {
      return new PartOfSpeechStandardScheme();
    }
  }

  private static class PartOfSpeechStandardScheme extends StandardScheme<PartOfSpeech> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PartOfSpeech struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartOfSpeech struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PartOfSpeechTupleSchemeFactory implements SchemeFactory {
    public PartOfSpeechTupleScheme getScheme() {
      return new PartOfSpeechTupleScheme();
    }
  }

  private static class PartOfSpeechTupleScheme extends TupleScheme<PartOfSpeech> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PartOfSpeech struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PartOfSpeech struct) throws org.apache.thrift.TException {
