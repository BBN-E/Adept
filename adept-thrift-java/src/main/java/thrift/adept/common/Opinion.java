 ...
 * The Class Opinion.
 */
public class Opinion implements org.apache.thrift.TBase<Opinion, Opinion._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Opinion");
  ...
  private static final org.apache.thrift.protocol.TField SUBJECTIVITY_FIELD_DESC = new org.apache.thrift.protocol.TField("subjectivity", org.apache.thrift.protocol.TType.I32, (short)4);
  private static final org.apache.thrift.protocol.TField POLARITY_FIELD_DESC = new org.apache.thrift.protocol.TField("polarity", org.apache.thrift.protocol.TType.I32, (short)5);
  ...
  static {
    schemes.put(StandardScheme.class, new OpinionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OpinionTupleSchemeFactory());
  }
   ...
   * @see Subjectivity
   */
  public Subjectivity subjectivity; // required
  /**
   * The polarity
   * 
   * @see Polarity
   */
  public Polarity polarity; // required
  /**
   * The id
   */
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * @see Subjectivity
     */
    SUBJECTIVITY((short)4, "subjectivity"),
    /**
     * The polarity
     * 
     * @see Polarity
     */
    POLARITY((short)5, "polarity"),
    /**
     * The id
     */
    ID((short)6, "id"),
  ...
  static {
    ...
    tmpMap.put(_Fields.SUBJECTIVITY, new org.apache.thrift.meta_data.FieldMetaData("subjectivity", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, Subjectivity.class)));
    tmpMap.put(_Fields.POLARITY, new org.apache.thrift.meta_data.FieldMetaData("polarity", org.apache.thrift.TFieldRequirementType.REQUIRED, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Opinion.class, metaDataMap);
  }
   ...
   * The token offset which is the index into token stream.
   */
  public Opinion setTokenOffset(TokenOffset tokenOffset) {
    this.tokenOffset = tokenOffset;
    return this;
  }
   ...
   * The token stream
   */
  public Opinion setTokenStream(TokenStream tokenStream) {
    this.tokenStream = tokenStream;
    return this;
  }
   ...
   * The char offset
   */
  public Opinion setCharOffset(CharOffset charOffset) {
   ...
   * @see Subjectivity
   */
  public Opinion setSubjectivity(Subjectivity subjectivity) {
    this.subjectivity = subjectivity;
    return this;
  }

  public void unsetSubjectivity() {
    this.subjectivity = null;
  }

  /** Returns true if field subjectivity is set (has been assigned a value) and false otherwise */
  public boolean isSetSubjectivity() {
    return this.subjectivity != null;
  }

  public void setSubjectivityIsSet(boolean value) {
    if (!value) {
      this.subjectivity = null;
    }
  }
   ...
   * @see Polarity
   */
  public Opinion setPolarity(Polarity polarity) {
    this.polarity = polarity;
    return this;
  }
   ...
   * The value
   */
  public Opinion setValue(String value) {
    this.value = value;
    return this;
  }
   ...
   * The algorithmName
   */
  public Opinion setAlgorithmName(String algorithmName) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SUBJECTIVITY:
      if (value == null) {
        ...
        setSubjectivity((Subjectivity)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Opinion)
      return this.equals((Opinion)that);
    return false;
  }

  public boolean equals(Opinion that) {
    if (that == null)
      return false;
    ...
    boolean this_present_subjectivity = true && this.isSetSubjectivity();
    boolean that_present_subjectivity = true && that.isSetSubjectivity();
    if (this_present_subjectivity || that_present_subjectivity) {
      if (!(this_present_subjectivity && that_present_subjectivity))
        return false;
      if (!this.subjectivity.equals(that.subjectivity))
        return false;
    }
  ...
  public int compareTo(Opinion other) {
    ...
    Opinion typedOther = (Opinion)other;
    ...
    lastComparison = Boolean.valueOf(isSetSubjectivity()).compareTo(typedOther.isSetSubjectivity());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSubjectivity()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.subjectivity, typedOther.subjectivity);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (this.subjectivity == null) {
      sb.append("null");
    } else {
      sb.append(this.subjectivity);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("polarity:");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (subjectivity == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'subjectivity' was not present! Struct: " + toString());
    }
    if (polarity == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'polarity' was not present! Struct: " + toString());
    }
  ...
  private static class OpinionStandardSchemeFactory implements SchemeFactory {
    public OpinionStandardScheme getScheme() {
      return new OpinionStandardScheme();
    }
  }

  private static class OpinionStandardScheme extends StandardScheme<Opinion> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Opinion struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // SUBJECTIVITY
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.subjectivity = Subjectivity.findByValue(iprot.readI32());
              struct.setSubjectivityIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 5: // POLARITY
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.polarity = Polarity.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Opinion struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.subjectivity != null) {
        oprot.writeFieldBegin(SUBJECTIVITY_FIELD_DESC);
        oprot.writeI32(struct.subjectivity.getValue());
        oprot.writeFieldEnd();
      }
  ...
  private static class OpinionTupleSchemeFactory implements SchemeFactory {
    public OpinionTupleScheme getScheme() {
      return new OpinionTupleScheme();
    }
  }

  private static class OpinionTupleScheme extends TupleScheme<Opinion> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Opinion struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Opinion struct) throws org.apache.thrift.TException {
