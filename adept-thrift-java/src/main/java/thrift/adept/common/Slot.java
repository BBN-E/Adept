...
public class Slot implements org.apache.thrift.TBase<Slot, Slot._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    ...
    tmpMap.put(_Fields.SLOT_ID, new org.apache.thrift.meta_data.FieldMetaData("slotId", org.apache.thrift.TFieldRequirementType.REQUIRED, 
   ...
   * The slot id
   */
  public Slot setSlotId(long slotId) {
    this.slotId = slotId;
    setSlotIdIsSet(true);
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'slotId' because it's a primitive and you chose the non-beans generator.
  ...
  private static class SlotStandardScheme extends StandardScheme<Slot> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Slot struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetSlotId()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'slotId' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
