 ...
 */
public class CommittedBelief implements org.apache.thrift.TBase<CommittedBelief, CommittedBelief._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CommittedBelief");
  ...
  private static final org.apache.thrift.protocol.TField MODALITY_FIELD_DESC = new org.apache.thrift.protocol.TField("modality", org.apache.thrift.protocol.TType.I32, (short)5);
  ...
  static {
    schemes.put(StandardScheme.class, new CommittedBeliefStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CommittedBeliefTupleSchemeFactory());
  }
   ...
   * @see Modality
   */
  public Modality modality; // required
  /**
   * The id
   */
  ...
  static {
    ...
    tmpMap.put(_Fields.MODALITY, new org.apache.thrift.meta_data.FieldMetaData("modality", org.apache.thrift.TFieldRequirementType.REQUIRED, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CommittedBelief.class, metaDataMap);
  }

  public CommittedBelief() {
  }
   ...
   */
  public CommittedBelief(CommittedBelief other) {
  ...
  public CommittedBelief deepCopy() {
    return new CommittedBelief(this);
  }
   ...
   * The sequence id
   */
  public CommittedBelief setSequenceId(long sequenceId) {
    this.sequenceId = sequenceId;
    setSequenceIdIsSet(true);
    return this;
  }
   ...
   * The token offset which is the index into token stream.
   */
  public CommittedBelief setTokenOffset(TokenOffset tokenOffset) {
    this.tokenOffset = tokenOffset;
    return this;
  }
   ...
   * The token stream
   */
  public CommittedBelief setTokenStream(TokenStream tokenStream) {
    this.tokenStream = tokenStream;
    return this;
  }
   ...
   * The char offset
   */
  public CommittedBelief setCharOffset(CharOffset charOffset) {
   ...
   * @see Modality
   */
  public CommittedBelief setModality(Modality modality) {
    this.modality = modality;
    return this;
  }
  ...
  /** Returns true if field modality is set (has been assigned a value) and false otherwise */
  public boolean isSetModality() {
    return this.modality != null;
  }

  public void setModalityIsSet(boolean value) {
    if (!value) {
      this.modality = null;
    }
  }
   ...
   * The id
   */
  public CommittedBelief setId(ID id) {
    this.id = id;
    return this;
  }
   ...
   * The value
   */
  public CommittedBelief setValue(String value) {
    this.value = value;
    return this;
  }
   ...
   * The algorithmName
   */
  public CommittedBelief setAlgorithmName(String algorithmName) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CommittedBelief)
      return this.equals((CommittedBelief)that);
    return false;
  }

  public boolean equals(CommittedBelief that) {
    if (that == null)
      return false;
    ...
    boolean this_present_modality = true && this.isSetModality();
    boolean that_present_modality = true && that.isSetModality();
    if (this_present_modality || that_present_modality) {
      if (!(this_present_modality && that_present_modality))
        return false;
      if (!this.modality.equals(that.modality))
        return false;
    }
  ...
  public int compareTo(CommittedBelief other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CommittedBelief typedOther = (CommittedBelief)other;
    ...
    lastComparison = Boolean.valueOf(isSetModality()).compareTo(typedOther.isSetModality());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetModality()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.modality, typedOther.modality);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CommittedBelief(");
    boolean first = true;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (modality == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'modality' was not present! Struct: " + toString());
    }
  ...
  private static class CommittedBeliefStandardSchemeFactory implements SchemeFactory {
    public CommittedBeliefStandardScheme getScheme() {
      return new CommittedBeliefStandardScheme();
    }
  }

  private static class CommittedBeliefStandardScheme extends StandardScheme<CommittedBelief> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CommittedBelief struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 5: // MODALITY
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.modality = Modality.findByValue(iprot.readI32());
              struct.setModalityIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CommittedBelief struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.modality != null) {
        oprot.writeFieldBegin(MODALITY_FIELD_DESC);
        oprot.writeI32(struct.modality.getValue());
        oprot.writeFieldEnd();
      }
      if (struct.id != null) {
        if (struct.isSetId()) {
  ...
  private static class CommittedBeliefTupleSchemeFactory implements SchemeFactory {
    public CommittedBeliefTupleScheme getScheme() {
      return new CommittedBeliefTupleScheme();
    }
  }

  private static class CommittedBeliefTupleScheme extends TupleScheme<CommittedBelief> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CommittedBelief struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CommittedBelief struct) throws org.apache.thrift.TException {
