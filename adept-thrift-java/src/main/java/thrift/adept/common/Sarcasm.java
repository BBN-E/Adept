 ...
 * The Class Sarcasm.
 */
public class Sarcasm implements org.apache.thrift.TBase<Sarcasm, Sarcasm._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Sarcasm");

  private static final org.apache.thrift.protocol.TField SARCASM_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("sarcasmId", org.apache.thrift.protocol.TType.I64, (short)1);
  ...
  private static final org.apache.thrift.protocol.TField JUDGMENT_FIELD_DESC = new org.apache.thrift.protocol.TField("judgment", org.apache.thrift.protocol.TType.I32, (short)5);
  private static final org.apache.thrift.protocol.TField CONFIDENCE_FIELD_DESC = new org.apache.thrift.protocol.TField("confidence", org.apache.thrift.protocol.TType.DOUBLE, (short)6);
  ...
  static {
    schemes.put(StandardScheme.class, new SarcasmStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SarcasmTupleSchemeFactory());
  }

  /**
   * The sarcasm id
   */
  public long sarcasmId; // required
  /**
   ...
   * @see SarcasmJudgment
   */
  public SarcasmJudgment judgment; // required
  /**
   * The confidence
   */
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * @see SarcasmJudgment
     */
    JUDGMENT((short)5, "judgment"),
    /**
     * The confidence
     */
    CONFIDENCE((short)6, "confidence"),
    /**
     * The id
     */
    ID((short)7, "id"),
  ...
  private static final int __SARCASMID_ISSET_ID = 0;
  private static final int __CONFIDENCE_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private _Fields optionals[] = {_Fields.CHAR_OFFSET,_Fields.CONFIDENCE,_Fields.ID,_Fields.VALUE,_Fields.ALGORITHM_NAME};
  public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
  static {
    Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.SARCASM_ID, new org.apache.thrift.meta_data.FieldMetaData("sarcasmId", org.apache.thrift.TFieldRequirementType.REQUIRED, 
    ...
    tmpMap.put(_Fields.JUDGMENT, new org.apache.thrift.meta_data.FieldMetaData("judgment", org.apache.thrift.TFieldRequirementType.REQUIRED, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Sarcasm.class, metaDataMap);
  }
  ...
  public Sarcasm(
    ...
    SarcasmJudgment judgment)
  {
    this();
    this.sarcasmId = sarcasmId;
    setSarcasmIdIsSet(true);
   ...
   */
  public Sarcasm(Sarcasm other) {
    __isset_bitfield = other.__isset_bitfield;
    this.sarcasmId = other.sarcasmId;
  ...
  public Sarcasm deepCopy() {
    return new Sarcasm(this);
  }

  @Override
  public void clear() {
    setSarcasmIdIsSet(false);
    this.sarcasmId = 0;
  ...
  public long getSarcasmId() {
    return this.sarcasmId;
  }

  /**
   * The sarcasm id
   */
  public Sarcasm setSarcasmId(long sarcasmId) {
    this.sarcasmId = sarcasmId;
    setSarcasmIdIsSet(true);
    return this;
  }

  public void unsetSarcasmId() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SARCASMID_ISSET_ID);
  }

  /** Returns true if field sarcasmId is set (has been assigned a value) and false otherwise */
  public boolean isSetSarcasmId() {
    return EncodingUtils.testBit(__isset_bitfield, __SARCASMID_ISSET_ID);
  }

  public void setSarcasmIdIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SARCASMID_ISSET_ID, value);
  }
   ...
   * The token offset which is the index into token stream.
   */
  public Sarcasm setTokenOffset(TokenOffset tokenOffset) {
    this.tokenOffset = tokenOffset;
    return this;
  }
   ...
   * The token stream
   */
  public Sarcasm setTokenStream(TokenStream tokenStream) {
    this.tokenStream = tokenStream;
    return this;
  }
   ...
   * The char offset
   */
  public Sarcasm setCharOffset(CharOffset charOffset) {
   ...
   * @see SarcasmJudgment
   */
  public Sarcasm setJudgment(SarcasmJudgment judgment) {
    this.judgment = judgment;
    return this;
  }
   ...
   * The confidence
   */
  public Sarcasm setConfidence(double confidence) {
   ...
   * The value
   */
  public Sarcasm setValue(String value) {
    this.value = value;
    return this;
  }
   ...
   * The algorithmName
   */
  public Sarcasm setAlgorithmName(String algorithmName) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case JUDGMENT:
      if (value == null) {
        ...
        setJudgment((SarcasmJudgment)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case SARCASM_ID:
      return Long.valueOf(getSarcasmId());
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Sarcasm)
      return this.equals((Sarcasm)that);
    return false;
  }

  public boolean equals(Sarcasm that) {
    if (that == null)
      return false;

    boolean this_present_sarcasmId = true;
    boolean that_present_sarcasmId = true;
    if (this_present_sarcasmId || that_present_sarcasmId) {
      if (!(this_present_sarcasmId && that_present_sarcasmId))
        return false;
      if (this.sarcasmId != that.sarcasmId)
        return false;
    }
  ...
  public int compareTo(Sarcasm other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    Sarcasm typedOther = (Sarcasm)other;

    lastComparison = Boolean.valueOf(isSetSarcasmId()).compareTo(typedOther.isSetSarcasmId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSarcasmId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sarcasmId, typedOther.sarcasmId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("Sarcasm(");
    boolean first = true;

    sb.append("sarcasmId:");
    sb.append(this.sarcasmId);
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'sarcasmId' because it's a primitive and you chose the non-beans generator.
    if (tokenOffset == null) {
    ...
    if (judgment == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'judgment' was not present! Struct: " + toString());
    }
  ...
  private static class SarcasmStandardSchemeFactory implements SchemeFactory {
    public SarcasmStandardScheme getScheme() {
      return new SarcasmStandardScheme();
    }
  }

  private static class SarcasmStandardScheme extends StandardScheme<Sarcasm> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Sarcasm struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // SARCASM_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.sarcasmId = iprot.readI64();
              struct.setSarcasmIdIsSet(true);
            } else { 
          ...
          case 5: // JUDGMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.judgment = SarcasmJudgment.findByValue(iprot.readI32());
      ...
      if (!struct.isSetSarcasmId()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'sarcasmId' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }

    public void write(org.apache.thrift.protocol.TProtocol oprot, Sarcasm struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      oprot.writeFieldBegin(SARCASM_ID_FIELD_DESC);
      oprot.writeI64(struct.sarcasmId);
      oprot.writeFieldEnd();
  ...
  private static class SarcasmTupleSchemeFactory implements SchemeFactory {
    public SarcasmTupleScheme getScheme() {
      return new SarcasmTupleScheme();
    }
  }

  private static class SarcasmTupleScheme extends TupleScheme<Sarcasm> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Sarcasm struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Sarcasm struct) throws org.apache.thrift.TException {
