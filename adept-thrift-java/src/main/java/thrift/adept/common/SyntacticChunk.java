 ...
 */
public class SyntacticChunk implements org.apache.thrift.TBase<SyntacticChunk, SyntacticChunk._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SyntacticChunk");
  ...
  private static final org.apache.thrift.protocol.TField SC_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("scType", org.apache.thrift.protocol.TType.STRUCT, (short)2);
  private static final org.apache.thrift.protocol.TField TOKEN_OFFSET_FIELD_DESC = new org.apache.thrift.protocol.TField("tokenOffset", org.apache.thrift.protocol.TType.STRUCT, (short)3);
  private static final org.apache.thrift.protocol.TField TOKEN_STREAM_FIELD_DESC = new org.apache.thrift.protocol.TField("tokenStream", org.apache.thrift.protocol.TType.STRUCT, (short)4);
  private static final org.apache.thrift.protocol.TField CHAR_OFFSET_FIELD_DESC = new org.apache.thrift.protocol.TField("charOffset", org.apache.thrift.protocol.TType.STRUCT, (short)5);
  ...
  static {
    schemes.put(StandardScheme.class, new SyntacticChunkStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SyntacticChunkTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * The syntactic chunk type
     */
    SC_TYPE((short)2, "scType"),
    /**
     * The token offset which is the index into token stream.
     */
    TOKEN_OFFSET((short)3, "tokenOffset"),
    /**
     * The token stream
     */
    TOKEN_STREAM((short)4, "tokenStream"),
    /**
     * The char offset
     */
    CHAR_OFFSET((short)5, "charOffset"),
    /**
     * The id
     */
    ID((short)6, "id"),
  ...
  static {
    ...
    tmpMap.put(_Fields.SC_TYPE, new org.apache.thrift.meta_data.FieldMetaData("scType", org.apache.thrift.TFieldRequirementType.REQUIRED, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SyntacticChunk.class, metaDataMap);
  }

  public SyntacticChunk() {
  }
   ...
   */
  public SyntacticChunk(SyntacticChunk other) {
    __isset_bitfield = other.__isset_bitfield;
    this.sequenceId = other.sequenceId;
    if (other.isSetScType()) {
      this.scType = new Type(other.scType);
    }
  ...
  public SyntacticChunk deepCopy() {
    return new SyntacticChunk(this);
  }
   ...
   * The sequence id
   */
  public SyntacticChunk setSequenceId(long sequenceId) {
    this.sequenceId = sequenceId;
    setSequenceIdIsSet(true);
    return this;
  }
   ...
   * The syntactic chunk type
   */
  public SyntacticChunk setScType(Type scType) {
    this.scType = scType;
    return this;
  }

  public void unsetScType() {
    this.scType = null;
  }

  /** Returns true if field scType is set (has been assigned a value) and false otherwise */
  public boolean isSetScType() {
    return this.scType != null;
  }

  public void setScTypeIsSet(boolean value) {
    if (!value) {
      this.scType = null;
    }
  }
   ...
   * The token offset which is the index into token stream.
   */
  public SyntacticChunk setTokenOffset(TokenOffset tokenOffset) {
    this.tokenOffset = tokenOffset;
    return this;
  }
   ...
   * The token stream
   */
  public SyntacticChunk setTokenStream(TokenStream tokenStream) {
    this.tokenStream = tokenStream;
    return this;
  }
   ...
   * The char offset
   */
  public SyntacticChunk setCharOffset(CharOffset charOffset) {
   ...
   * The id
   */
  public SyntacticChunk setId(ID id) {
    this.id = id;
    return this;
  }
   ...
   * The value
   */
  public SyntacticChunk setValue(String value) {
    this.value = value;
    return this;
  }
   ...
   * The algorithmName
   */
  public SyntacticChunk setAlgorithmName(String algorithmName) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SyntacticChunk)
      return this.equals((SyntacticChunk)that);
    return false;
  }

  public boolean equals(SyntacticChunk that) {
    if (that == null)
      return false;
    ...
    boolean this_present_scType = true && this.isSetScType();
    boolean that_present_scType = true && that.isSetScType();
    if (this_present_scType || that_present_scType) {
      if (!(this_present_scType && that_present_scType))
        return false;
      if (!this.scType.equals(that.scType))
        return false;
    }
  ...
  public int compareTo(SyntacticChunk other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    SyntacticChunk typedOther = (SyntacticChunk)other;
    ...
    lastComparison = Boolean.valueOf(isSetScType()).compareTo(typedOther.isSetScType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetScType()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.scType, typedOther.scType);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SyntacticChunk(");
    boolean first = true;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (scType == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'scType' was not present! Struct: " + toString());
    }
    if (tokenOffset == null) {
  ...
  private static class SyntacticChunkStandardSchemeFactory implements SchemeFactory {
    public SyntacticChunkStandardScheme getScheme() {
      return new SyntacticChunkStandardScheme();
    }
  }

  private static class SyntacticChunkStandardScheme extends StandardScheme<SyntacticChunk> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SyntacticChunk struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 2: // SC_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.scType = new Type();
              struct.scType.read(iprot);
              struct.setScTypeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SyntacticChunk struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeFieldEnd();
      if (struct.scType != null) {
        oprot.writeFieldBegin(SC_TYPE_FIELD_DESC);
        struct.scType.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class SyntacticChunkTupleSchemeFactory implements SchemeFactory {
    public SyntacticChunkTupleScheme getScheme() {
      return new SyntacticChunkTupleScheme();
    }
  }

  private static class SyntacticChunkTupleScheme extends TupleScheme<SyntacticChunk> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SyntacticChunk struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SyntacticChunk struct) throws org.apache.thrift.TException {
