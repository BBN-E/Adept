...
public class CommittedBeliefService {

  public interface Iface extends ChunkService.Iface {

    public Modality getModality() throws org.apache.thrift.TException;
  ...
  public interface AsyncIface extends ChunkService .AsyncIface {
    ...
    public void getModality(org.apache.thrift.async.AsyncMethodCallback<AsyncClient.getModality_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends ChunkService.Client implements Iface {
    ...
    public void send_getModality() throws org.apache.thrift.TException
    {
      getModality_args args = new getModality_args();
      sendBase("getModality", args);
    }

    public Modality recv_getModality() throws org.apache.thrift.TException
    {
      getModality_result result = new getModality_result();
      receiveBase(result, "getModality");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "getModality failed: unknown result");
    }
  ...
  public static class AsyncClient extends ChunkService.AsyncClient implements AsyncIface {
    ...
    public void getModality(org.apache.thrift.async.AsyncMethodCallback<getModality_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getModality_call method_call = new getModality_call(resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getModality_call extends org.apache.thrift.async.TAsyncMethodCall {
      public getModality_call(org.apache.thrift.async.AsyncMethodCallback<getModality_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("getModality", org.apache.thrift.protocol.TMessageType.CALL, 0));
        getModality_args args = new getModality_args();
        args.write(prot);
        prot.writeMessageEnd();
      }

      public Modality getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getModality();
      }
    }
  ...
  public static class Processor<I extends Iface> extends ChunkService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      processMap.put("getModality", new getModality());
      processMap.put("getSequenceId", new getSequenceId());
      return processMap;
    }

    public static class getModality<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getModality_args> {
      public getModality() {
        super("getModality");
      }

      public getModality_args getEmptyArgsInstance() {
        return new getModality_args();
      }
      ...
      public getModality_result getResult(I iface, getModality_args args) throws org.apache.thrift.TException {
        getModality_result result = new getModality_result();
        result.success = iface.getModality();
        return result;
      }
    }
  ...
  public static class getModality_args implements org.apache.thrift.TBase<getModality_args, getModality_args._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getModality_args");


    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getModality_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getModality_argsTupleSchemeFactory());
    }
...
;
    ...
    static {
      ...
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getModality_args.class, metaDataMap);
    }

    public getModality_args() {
    }

    /**
     * Performs a deep copy on <i>other</i>.
     */
    public getModality_args(getModality_args other) {
    }

    public getModality_args deepCopy() {
      return new getModality_args(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getModality_args)
        return this.equals((getModality_args)that);
      return false;
    }

    public boolean equals(getModality_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(getModality_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      getModality_args typedOther = (getModality_args)other;
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("getModality_args(");
      boolean first = true;
    ...
    private static class getModality_argsStandardSchemeFactory implements SchemeFactory {
      public getModality_argsStandardScheme getScheme() {
        return new getModality_argsStandardScheme();
      }
    }

    private static class getModality_argsStandardScheme extends StandardScheme<getModality_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getModality_args struct) throws org.apache.thrift.TException {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getModality_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getModality_argsTupleSchemeFactory implements SchemeFactory {
      public getModality_argsTupleScheme getScheme() {
        return new getModality_argsTupleScheme();
      }
    }

    private static class getModality_argsTupleScheme extends TupleScheme<getModality_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getModality_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      }

      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getModality_args struct) throws org.apache.thrift.TException {
  ...
  public static class getModality_result implements org.apache.thrift.TBase<getModality_result, getModality_result._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getModality_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.I32, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getModality_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getModality_resultTupleSchemeFactory());
    }
     ...
     * @see Modality
     */
    public Modality success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, Modality.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getModality_result.class, metaDataMap);
    }

    public getModality_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getModality_result(getModality_result other) {
      if (other.isSetSuccess()) {
        this.success = other.success;
      }
    }

    public getModality_result deepCopy() {
      return new getModality_result(this);
    }
     ...
     * @see Modality
     */
    public getModality_result setSuccess(Modality success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getModality_result)
        return this.equals((getModality_result)that);
      return false;
    }

    public boolean equals(getModality_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(getModality_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      getModality_result typedOther = (getModality_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getModality_result(");
      boolean first = true;
    ...
    private static class getModality_resultStandardSchemeFactory implements SchemeFactory {
      public getModality_resultStandardScheme getScheme() {
        return new getModality_resultStandardScheme();
      }
    }

    private static class getModality_resultStandardScheme extends StandardScheme<getModality_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getModality_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.success = Modality.findByValue(iprot.readI32());
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getModality_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getModality_resultTupleSchemeFactory implements SchemeFactory {
      public getModality_resultTupleScheme getScheme() {
        return new getModality_resultTupleScheme();
      }
    }

    private static class getModality_resultTupleScheme extends TupleScheme<getModality_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getModality_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getModality_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
