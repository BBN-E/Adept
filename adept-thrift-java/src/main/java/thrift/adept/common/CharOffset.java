 ...
 * spans.
 */
public class CharOffset implements org.apache.thrift.TBase<CharOffset, CharOffset._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CharOffset");

  private static final org.apache.thrift.protocol.TField BEGIN_INDEX_FIELD_DESC = new org.apache.thrift.protocol.TField("beginIndex", org.apache.thrift.protocol.TType.I32, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new CharOffsetStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CharOffsetTupleSchemeFactory());
  }

  /**
   * The begin index
   */
  public int beginIndex; // required
  /**
   * The end index
   */
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CharOffset.class, metaDataMap);
  }
   ...
   */
  public CharOffset(CharOffset other) {
    __isset_bitfield = other.__isset_bitfield;
    this.beginIndex = other.beginIndex;
    this.endIndex = other.endIndex;
  }

  public CharOffset deepCopy() {
    return new CharOffset(this);
  }
   ...
   * The begin index
   */
  public CharOffset setBeginIndex(int beginIndex) {
    this.beginIndex = beginIndex;
    setBeginIndexIsSet(true);
    return this;
  }
   ...
   * The end index
   */
  public CharOffset setEndIndex(int endIndex) {
    this.endIndex = endIndex;
    setEndIndexIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CharOffset)
      return this.equals((CharOffset)that);
    return false;
  }

  public boolean equals(CharOffset that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CharOffset other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CharOffset typedOther = (CharOffset)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CharOffset(");
    boolean first = true;
  ...
  private static class CharOffsetStandardSchemeFactory implements SchemeFactory {
    public CharOffsetStandardScheme getScheme() {
      return new CharOffsetStandardScheme();
    }
  }

  private static class CharOffsetStandardScheme extends StandardScheme<CharOffset> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CharOffset struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // BEGIN_INDEX
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.beginIndex = iprot.readI32();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CharOffset struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      oprot.writeFieldBegin(BEGIN_INDEX_FIELD_DESC);
      oprot.writeI32(struct.beginIndex);
      oprot.writeFieldEnd();
  ...
  private static class CharOffsetTupleSchemeFactory implements SchemeFactory {
    public CharOffsetTupleScheme getScheme() {
      return new CharOffsetTupleScheme();
    }
  }

  private static class CharOffsetTupleScheme extends TupleScheme<CharOffset> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CharOffset struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CharOffset struct) throws org.apache.thrift.TException {
