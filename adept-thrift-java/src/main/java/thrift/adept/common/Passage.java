 ...
 * The Class Passage.
 */
public class Passage implements org.apache.thrift.TBase<Passage, Passage._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Passage");
  ...
  static {
    schemes.put(StandardScheme.class, new PassageStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PassageTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.CHAR_OFFSET,_Fields.CONTENT_TYPE,_Fields.ID,_Fields.VALUE,_Fields.ALGORITHM_NAME};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Passage.class, metaDataMap);
  }
   ...
   * The sequence id
   */
  public Passage setSequenceId(long sequenceId) {
    this.sequenceId = sequenceId;
    setSequenceIdIsSet(true);
    return this;
  }
   ...
   * The token offset which is the index into token stream.
   */
  public Passage setTokenOffset(TokenOffset tokenOffset) {
    this.tokenOffset = tokenOffset;
    return this;
  }
   ...
   * The token stream
   */
  public Passage setTokenStream(TokenStream tokenStream) {
    this.tokenStream = tokenStream;
    return this;
  }
   ...
   * The char offset
   */
  public Passage setCharOffset(CharOffset charOffset) {
   ...
   * The content type
   */
  public Passage setContentType(String contentType) {
   ...
   * The value
   */
  public Passage setValue(String value) {
    this.value = value;
    return this;
  }
   ...
   * The algorithmName
   */
  public Passage setAlgorithmName(String algorithmName) {
  ...
  public boolean equals(Object that) {
    ...
    if (that instanceof Passage)
      return this.equals((Passage)that);
    return false;
  }

  public boolean equals(Passage that) {
    if (that == null)
      return false;
  ...
  public int compareTo(Passage other) {
    ...
    Passage typedOther = (Passage)other;
  ...
  private static class PassageStandardSchemeFactory implements SchemeFactory {
    public PassageStandardScheme getScheme() {
      return new PassageStandardScheme();
    }
  }

  private static class PassageStandardScheme extends StandardScheme<Passage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Passage struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Passage struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PassageTupleSchemeFactory implements SchemeFactory {
    public PassageTupleScheme getScheme() {
      return new PassageTupleScheme();
    }
  }

  private static class PassageTupleScheme extends TupleScheme<Passage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Passage struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Passage struct) throws org.apache.thrift.TException {
