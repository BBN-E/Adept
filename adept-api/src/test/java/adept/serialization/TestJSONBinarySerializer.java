...
public class TestJSONBinarySerializer {
	public static void main(String[] args) throws UnsupportedEncodingException {
		AbstractBinarySerializer serializer = new JSONBinarySerializer();
		...
		byte[] serialized = serializer.serializeToByteArray(document);
		Document deserialized = (Document) serializer.deserializeFromByteArray(serialized, Document.class);

		// test results from deserialization
		System.out.println("Printing out the document object from just deserialized binary:");
