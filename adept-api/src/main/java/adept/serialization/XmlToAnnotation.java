...
public class XmlToAnnotation 
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		XMLStringSerializer ser = new XMLStringSerializer();
		HltContentContainer hltCC = (HltContentContainer) ser.deserializeFromString(fileData, HltContentContainer.class);
		// DEBUG code
//		String xmlFilename = inFile + ".debug.xml";
//		String xmlTemp = ser.serializeToString(hltCC);
...
//					Chunk chunk = argument.getBestArgument();
	...
	protected static String makeEntId( EntityMention em )
	{
		...
		else
		{
			...
			Iterator<Entry<Long, Float>> it = entDistrib.entrySet().iterator();
			while (it.hasNext()) 
			{
