 ...
 */
public abstract class NamedEntityTagger extends AbstractModule implements
		ISentenceProcessor<EntityMention>, IPassageProcessor<EntityMention> {
	 ...
	 */
	@Override
	public List<EntityMention> process(Passage passage) {
		// TODO Auto-generated method stub
		return null;
	}
