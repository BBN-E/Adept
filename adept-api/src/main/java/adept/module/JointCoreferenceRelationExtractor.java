...
/**
 * The Class JointCoreferenceRelationExtractor - An instance can be created to
 * support JointRelationCoreference output.
 */
public abstract class JointCoreferenceRelationExtractor extends AbstractModule implements IDocumentProcessor {
    /* (non-Javadoc)
