...
/**
 * The Class AcousticInteractionAnalyzer - An instance can be created to
 * support InterPausalUnit output.
 */
public abstract class AcousticInteractionAnalyzer extends AbstractModule implements IDocumentProcessor {
    /* (non-Javadoc)
