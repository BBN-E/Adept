...
public class ConversationElement implements HasOntologizedAttributes, HasFreeTextAttributes, HasConversationElementTagAttributes, 
        IConversationElementRelation, IConversationElementEntityRelation, Serializable
{
	private static final long serialVersionUID = 6945019283799827223L;
