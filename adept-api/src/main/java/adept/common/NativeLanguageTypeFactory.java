...
public class NativeLanguageTypeFactory {
	...
	private Properties nativeLanguageTypeCatalog = null;
	
    /** Singleton instance. */
	private static final NativeLanguageTypeFactory nltFactory = new NativeLanguageTypeFactory();
	...
	public static NativeLanguageTypeFactory getInstance(String nativeLanguageTypeCatalog)
		...
		if (nltFactory.nativeLanguageTypeCatalog == null) {
