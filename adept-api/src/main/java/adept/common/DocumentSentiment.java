...
/**
 * <p>Represents a sentiment at the level of participating document-level entities, relations, and arguments,
 ...
 * that are instances of {@link adept.common.SentimentMention}. </p>
 * 
 * <p>This is a new class introduced in the API release version 2.1, and is the
 * primary class to be used in inserting sentiments into the Adept KB.</p>
 */
public final class DocumentSentiment extends DocumentMentalState<SentimentMention> {
    ...
    public static final class Builder extends DocumentMentalState.Builder<SentimentMention> {
        @Override
