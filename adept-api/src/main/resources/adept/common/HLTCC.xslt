			...
			<body style="color:#222222; " onload="Altova.init();">
				<xsl:for-each select="$XML">
					<xsl:for-each select="adept.common.HltContentContainer">
							...
							<li>
								<xsl:choose>
									<xsl:when test="count(/descendant::tokenStream[1]) &gt; 0">
										<a>
											<xsl:choose>
												<xsl:when test="not(string(&apos;#Sentence Similarities&apos;))">
													<xsl:attribute name="href">
														<xsl:text>#</xsl:text>
													</xsl:attribute>
												</xsl:when>
												<xsl:when test="substring(string(&apos;#Sentence Similarities&apos;), 1, 1) = '#'">
													<xsl:attribute name="href">
														<xsl:value-of select="&apos;#Sentence Similarities&apos;"/>
													</xsl:attribute>
												</xsl:when>
												<xsl:otherwise>
													<xsl:attribute name="href">
														<xsl:if test="substring(string(&apos;#Sentence Similarities&apos;), 2, 1) = ':'">
															<xsl:text>file:///</xsl:text>
														</xsl:if>
														<xsl:value-of select="translate(string(&apos;#Sentence Similarities&apos;), '&#x5c;', '/')"/>
													</xsl:attribute>
												</xsl:otherwise>
											</xsl:choose>
											<span>
												<xsl:text>Sentence Similarities</xsl:text>
											</span>
										</a>
									</xsl:when>
									<xsl:otherwise>
										...
										<table style="border-collapse:collapse; margin-top:10px; " class="altova-add-row-expand-collapse-buttons">
											...
											<thead style="margin:2px; " align="left">
												<tr align="left" bgcolor="#697376">
													...
													<xsl:variable name="bColumnCondition_0x129B7A00">
													...
													<xsl:if test="$bColumnCondition_0x129B7A00 = 'true'">
						...
						<xsl:for-each select="sentenceSimilarities">
							<a>
								<xsl:attribute name="name">
									<xsl:value-of select="&apos;Sentence Similarities&apos;"/>
								</xsl:attribute>
							...
							<center style="background:#323d40; color:white; ">
								...
								<a>
									<xsl:choose>
										<xsl:when test="not(string(&apos;help.htm#Sentence Similarities&apos;))">
											<xsl:attribute name="href">
												<xsl:text>#</xsl:text>
											</xsl:attribute>
										</xsl:when>
										<xsl:when test="substring(string(&apos;help.htm#Sentence Similarities&apos;), 1, 1) = '#'">
											<xsl:attribute name="href">
												<xsl:value-of select="&apos;help.htm#Sentence Similarities&apos;"/>
											</xsl:attribute>
										</xsl:when>
										<xsl:otherwise>
											<xsl:attribute name="href">
												<xsl:if test="substring(string(&apos;help.htm#Sentence Similarities&apos;), 2, 1) = ':'">
													<xsl:text>file:///</xsl:text>
												</xsl:if>
												<xsl:value-of select="translate(string(&apos;help.htm#Sentence Similarities&apos;), '&#x5c;', '/')"/>
											</xsl:attribute>
										</xsl:otherwise>
									</xsl:choose>
									<img align="bottom">
							...
							<center>
								<table style="border-bottom:solid gray thin; border-collapse:collapse; border-left:solid gray thin; border-right:solid gray thin; border-top:solid gray thin; margin-top:10px; " border="2" frame="border">
									<xsl:variable name="altova:CurrContextGrid_15" select="."/>
									<thead align="left">
										<tr align="left" bgcolor="#697376">
											<th style="text-align:left; " width="384">
												<span>
													<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Sentence 1</xsl:text>
												</span>
											</th>
											<th width="384">
												<span>
													<xsl:text>Sentence 2</xsl:text>
												</span>
											</th>
											<th>
												<span>
													<xsl:text>Similarity Metric</xsl:text>
												</span>
											</th>
											<th>
												<span>
													<xsl:text>Similarity Score</xsl:text>
												</span>
											</th>
										</tr>
									</thead>
									<tbody>
										<xsl:for-each select="adept.common.SentenceSimilarity">
											<xsl:variable name="color" select="concat(substring(&quot;white&quot;, 1 div ( position() mod 2 = 0 )), substring(&quot;lightgray&quot;, 1 div not(( position() mod 2 = 0 ))))"/>
											<tr bgcolor="white" class="altova-expand-collapse-level-1">
												<td style="text-align:left; " width="384">
													<xsl:for-each select="sentence1">
														<xsl:for-each select="value">
															<xsl:apply-templates/>
														</xsl:for-each>
													</xsl:for-each>
												...
												<td align="center">
													<xsl:for-each select="similarity">
														<xsl:for-each select="entry">
						...
						<xsl:for-each select="/descendant::tokenStream[1]">
							...
							<a>
								...
								<center>
									<table style="border-color:transparent; border-left-color:transparent; border-right-color:transparent; border-top-color:transparent; vertical-align:top; " bgcolor="white" border="0" width="auto">
